...
export interface MandatoryRequirement {
    ...
    valueType?: string;
    /** Entity id of PlayerAction#value(), when available */
    valueId?: EntityId;
}
...
export type PatchOp = PatchOpSet | PatchOpRemove | PatchOpArrayPush | PatchOpArrayRemoveItem;
