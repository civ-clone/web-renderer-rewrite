...
**Tests**: Include test tasks for every user story. Write failing tests first, then
implement to green.
...
- [ ] T010 [P] Add deterministic seed/replay test harness scaffolding
...
- [ ] T013 [P] [US1] Deterministic replay test in tests/integration/test_[name]_determinism.py
...
- [ ] TXXX [P] Bundle impact check and dependency justification updates
...
Task: "Deterministic replay test in tests/integration/test_[name]_determinism.py"
...
- Include determinism and performance checks when simulation/render paths are touched
